...
public class LogCommandLineOptions {
    ...
    public static final String MERGED_DIR_DESC =
            "Optional, String , merged result output dir, default <the value of System.getProperty(\"user.dir\")> .";
    ...
    public static final String CAPTURE_EXCEL_LONG = "snapshot-excel";
    public static final String CAPTURE_EXCEL_DEFAULT = "true";
    public static final String CAPTURE_EXCEL_DESC =
            "Optional, Boolean, snapshot excel info a picture, default <" + CAPTURE_EXCEL_DEFAULT + "> .";
